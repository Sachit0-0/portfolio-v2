...
export const Footer = () => {
  return (
    <footer id="footer">
      ...
      <section className="container py-20 grid grid-cols-4 md:grid-cols-4 xl:grid-cols-6 gap-x-8 gap-y-8">
        ...
        <div className="flex gap-2 items-center">
          <Phone size={18} />
          <a href="tel:+977-1-4572116" className="opacity-60 hover:opacity-100">
            9803033781
          </a>
        </div>
      </section>
