      ...
      />
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-2xl md:text-3xl">Explore some of the technologies I work with</p>
                </motion.div>
                <motion.div
                    className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-6 sm:gap-8 max-w-6xl mx-auto justify-items-center"
                    initial="hidden"
                    animate="visible"
                    variants={{
                        hidden: {},
                    ...
                    {technologies.map((tech, index) => (
                        <motion.div
                            ...
                            variants={{
                                ...
                                visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.9, ease: [0.4, 0, 0.2, 1] } },
                            }}
                        >
                            <TechCard
                                tech={tech}
